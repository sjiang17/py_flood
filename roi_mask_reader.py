...
def make_dataset(occ_data_dir, unocc_data_dir, mask_data_dir, pairFile_dir, phase):
...
class FeatureReader(data.Dataset):
    def __init__(self, occ_data_dir, unocc_data_dir, mask_data_dir,pairFile_dir, phase, fm_loader=h5_loader):
        data_list = make_dataset(occ_data_dir, unocc_data_dir, mask_data_dir, pairFile_dir, phase)
        if len(data_list) == 0:
