...
from G_Net_ResNet import build_GNet_ResNet
...
lr = 0.01
# n_blocks = 5
training_name = 'ResNet_conv{}_lr{}_{}_xavier'.format('4', lr, 'SGD_wd')
...
save_dir = os.path.join('save', 'ResNet', training_name)
...
model_trans = build_GNet_ResNet(use_dropout=False)
if use_gpu:
...
train_model(model_trans, criterion, optimizer_trans, num_epochs=200)
