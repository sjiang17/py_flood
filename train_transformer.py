...
lr = 0.01
training_name = 'kitti_UNet_lr{}_{}'.format('4', lr, 'SGD_dropout')
...
def train_model(model, criterion, optimizer, num_epochs=200):
    ...
    for epoch in range(170, num_epochs+1):
...
train_model(model_trans, criterion, optimizer_trans, num_epochs=250)
